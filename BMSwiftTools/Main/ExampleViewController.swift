...
//        self.view.backgroundColor = UIColor.init(red: 244.0 / 255.0, green: 245.0 / 255.0, blue: 245.0 / 255.0, alpha: 1.0)
    ...
    func stringTest() {
        ...
        let str6 = text[index3]
        print(str6)
        // 结果: i
        
        let str7 = text[index4]
        print(str7)
        // 结果: S
        
        // 获取指定位置字符串
        let range = text.range(of: "iOS")!
        let lower = text[text.startIndex..<range.lowerBound]
        print(lower)
        // 结果: 我是
        
        let upper = text[text.startIndex..<range.upperBound]
        print(upper)
        // 结果: 我是iOS
        ...
        //        let middle = timeString.substring(with: NSRange(startRange..<endRange))
        //
        //        // Range使用：
